...
header, [data-testid="stHeader"] {
    visibility: visible !important; background: transparent !important; height: 0 !important;
}
...
[data-testid="collapsedControl"] button {
    ...
    border: none !important; background: #4b1fcf !important; color: #ffffff !important;
    box-shadow: 0 6px 18px rgba(75,31,207,0.30) !important;
}
[data-testid="collapsedControl"] button:hover { background: #3d18b4 !important; }

[data-testid="stSidebar"] {
    background: #6B4FC8 !important;
    border-right: none !important; box-shadow: 10px 0 28px rgba(75,31,207,0.16) !important;
}
[data-testid="stSidebar"] > div:first-child { padding: 1rem 0.85rem !important; }
[data-testid="stSidebar"][aria-expanded="true"]  { min-width: 265px !important; max-width: 265px !important; }
[data-testid="stSidebar"][aria-expanded="false"] { min-width: 82px  !important; max-width: 82px  !important; }
[data-testid="stAppViewContainer"] > .main { background: #f6f7fb !important; }
.block-container { 
...
.jobie-brand {
    ...
    border-radius: 18px; padding: 0.95rem 1rem; display: flex; align-items: center;
    gap: 0.8rem; margin-bottom: 1.15rem; min-height: 72px;
}
.jobie-brand-logo {
    width: 42px; height: 42px; border-radius: 14px; background: #FFFFFF;
    color: #4b1fcf !important; display: flex; align-items: center;
    justify-content: center; font-size: 1.05rem; font-weight: 800; flex-shrink: 0;
}
.jobie-brand-title    { font-size: 1rem;   font-weight: 700; color: #FFFFFF !important; }
.jobie-brand-subtitle { font-size: 0.72rem; color: rgba(255,255,255,0.72) !important; margin-top: 0.18rem; }
.sidebar-section-label {
    font-size: 0.72rem; font-weight: 700; color: rgba(255,255,255,0.66) !important;
...
.jobie-sidebar-footer-title { font-size: 0.9rem; font-weight: 700; color: #FFFFFF !important; margin-bottom: 0.3rem; }
.jobie-sidebar-footer-text  { font-size: 0.77rem; line-height: 1.55; color: rgba(255,255,255,0.76) !important; }

.stat-card {
    border-radius: 14px; padding: 1.25rem 1.5rem; border: 1px solid rgba(0,0,0,.05);
    box-shadow: 0 4px 12px rgba(0,0,0,.08); transition: box-shadow .3s, transform .3s; color: white !important;
}
...
/* Chart cards - single clean border around entire visualization INCLUDING button */
...
[data-testid="stMain"] [data-testid="stBaseButton-secondary"] {
    ...
    padding: .42rem 0 !important; font-size: .82rem !important; font-weight: 600 !important;
    letter-spacing: .05em !important; width: 100% !important;
    box-shadow: 0 2px 8px rgba(99,102,241,.28) !important; transition: all .2s !important;
}
...
[data-testid="stMain"] [data-testid="stBaseButton-secondary"]:hover {
    ...
    box-shadow: 0 4px 16px rgba(99,102,241,.42) !important; transform: translateY(-1px) !important;
}
